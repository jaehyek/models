...
_DATA_URL = 'http://122.38.108.102/file/data/korean/images/koreans.tgz'

# The number of images in the validation set.
_NUM_VALIDATION = 244400
...
def _get_filenames_and_classes(dataset_dir):
  ...
  """
  koreans_root = os.path.join(dataset_dir, 'korean_photos')
  directories = []
  class_names = []
...
def _get_dataset_filename(dataset_dir, split_name, shard_id):
  output_filename = 'koreans_%s_%05d-of-%05d.tfrecord' % (
...
def _clean_up_temporary_files(dataset_dir):
  ...
  tmp_dir = os.path.join(dataset_dir, 'korean_photos')
