...
def run_other_dir(dataset_dir, output_suffix):
 ...
 """
  ...
  training_filenames, class_names = _get_filenames_and_classes(dataset_dir, 'apparelv_dabainsang_without_dummy\\train')
  validation_filenames, class_names = _get_filenames_and_classes(dataset_dir,
                                                                 'apparelv_dabainsang_without_dummy\\validation')
...
def run(dataset_dir, custom_binary_validation=None, custom_binary_validation_label=None,
  ...
  if custom_binary_validation:
    tmp_photo_filenames, class_names = _get_filenames_and_classes_by_label(dataset_dir, 'apparelv_binary_without_dummy')
    ...
    photo_filenames, class_names = _get_filenames_and_classes(dataset_dir, 'apparelv_binary_without_dummy')
